...
type NewUiTrechInjuryWizardProps = {
  step: number;
  plusDice: string;
  minusDice: string;
...
export default function NewUiTrechInjuryWizard({
  step,
  plusDice,
  minusDice,
  positiveModifier,
